...
const HeroSection = () => {
    return (
        <section className="px-24 md:px-30 pt-18 grid gap-20">
            ...
            <div className="bg-[url(/road-line.svg)] bg-no-repeat bg-contain relative h-[115lvw] w-[90%] m-auto">
                ...
                <Image src="/images/capming01.png" height={1200} width={1200} className="absolute w-[30vw] top-[7vw] right-[0vh]" alt="capming01" />
                ...
                <Image src="/images/capming02.png" height={1200} width={1200} className="absolute w-[36vw] top-[39vw] -left-[2vh]" alt="capming02" />
                <div className="absolute top-[42vw] right-[0vh] text-center">
                    <p className=" text-baralee-orange text-[2.5vw] font-medium">we provide you the best experience</p>
                    <p className=" text-[1.5vw] font-light">“Where the WiFi is weak, but the connection is strong.”</p>
                </div>

                <Image src="/images/coffee.png" height={1200} width={1200} className="absolute w-[28vw] top-[49vw] -right-[5vh]" alt="coffee" />
                <div className="absolute top-[65vw] left-[0vh] text-center">
                    <p className=" text-baralee-orange text-[2.5vw] font-medium">we provide you the best experience</p>
                    <p className=" text-[1.5vw] font-light">“Where the WiFi is weak, but the connection is strong.”</p>
                </div>

                <Image src="/images/cat-re-bg.png" height={1200} width={1200} className="-rotate-y-180 absolute w-[20vw] top-[79vw] -left-[6vh]" alt="cat-re-bg" />
