                ...
                {!desktopSize && (
                    <div className='grid gap-4'>
                        <div ref={(el: HTMLDivElement) => { elements.current[0] = el }} className="m-auto w-[80vw]" >
                            <div className=" text-center">
                                <p className=" text-baralee-orange text-[5vw] font-medium">we provide you the best experience</p>
                                <p className=" text-[3.5vw] font-light">“Where the WiFi is weak, but the connection is strong.”</p>
                            </div>
                            <Image src="/images/capming01.png" height={1200} width={1200} alt="capming01" />
                        </div>
                        <div className='flex justify-center gap-3'>
                            ...
                            <svg width="2" height="150" viewBox="0 0 2 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.99938 1C1.74745 2.51079 1.00027 35.1007 0.999943 40.0647C0.999616 45.0288 0.999323 150 0.999323 150" stroke="black" />
                            </svg>
                        </div>
